  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 md:py-8 space-y-6 md:space-y-8">
        {/* Add Fee Form */}
        <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-slate-100 p-4 md:p-6">
          <h2 className="font-semibold text-sm md:text-base text-slate-800 mb-4">
            Add New Fee
          </h2>
          <form
            onSubmit={handleAddFee}
            className="space-y-3 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-5 md:gap-3"
          >
            <input
              required
            ...
            <button
              type="submit"
              className="lg:col-span-1 md:col-span-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg transition"
            >
              Add Fee
            </button>
          </form>
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          Matric: {payment.profiles?.student_id}
                        </p>
                      </div>
                      <span
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 text-xs font-medium text-green-600 hover:bg-green-50 py-2 rounded transition"
                      >
                        Confirm
                      </button>
                      <button
                        ...
                        className="flex-1 text-xs font-medium text-red-500 hover:bg-red-50 py-2 rounded transition"
                      >
                        Reject
                      </button>
                    </div>
